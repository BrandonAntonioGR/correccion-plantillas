...
public class REF_GPT1 {
    ...
    public REF_GPT1(String number, String dpd, String clientFullName, String nombre, String open_principal, String speiClave, String oxxoReference, String extension20, String extension30, String saldoHoy, String adeudo, Date fechaPago, String tel, String algoritmo, String tipoCliente) {
        this.number = number;
        this.dpd = dpd;
